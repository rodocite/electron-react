...
/******/ 	var hotCurrentHash = "a39702c6c1a45338db01"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsContainerJsx = __webpack_require__(162);

	var _componentsContainerJsx2 = _interopRequireDefault(_componentsContainerJsx);

	(0, _reactDom.render)(_react2['default'].createElement(_componentsContainerJsx2['default'], null), document.getElementById('react-entry'));
	...
	var Container = (function (_Component) {
	  ...
	  _createClass(Container, [{
	    ...
	    value: function readFile() {
	      fs.readFile(__dirname + '/public/filesystem/names.txt', function (err, data) {
	        if (err) throw err;
	        console.log(data);
	      });
	    }
